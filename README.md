...
| 日期 | 标题 | 关键词 |
|------|------|--------|
| 09-03 | [2026-09-03.md](./ch10_每日前沿/2026-09-03.md) | 厂商方案、端到端、VLA、世界模型、纯视觉、无图智驾、跨域融合、城市领航、Robotaxi、量产定点、L3、中央计算平台、舱驾一体、数据闭环、前装量产 |
| 09-02 | [2026-09-02.md](./ch10_每日前沿/2026-09-02.md) | 城市NOA、车位到车位、无图智驾、纯视觉、端到端大模型、VLA、AI代驾、域控制器、Thor Ultra、激光雷达、前装量产、Robotaxi、无人化出行、SoC、AEB |
| 09-01 | [2026-09-01.md](./ch10_每日前沿/2026-09-01.md) | VLA、世界模型、视频生成、边缘案例、数据闭环、Robotaxi、固态激光雷达、Thor、算力芯片、去图化、端到端、车路云协同、5G-A、安全评估、智能化测评 |
