...
| 日期 | 标题 | 关键词 |
|------|------|--------|
| 09-25 | [2026-09-25.md](./ch10_每日前沿/2026-09-25.md) | 端到端、VLA、世界模型、Occupancy Network、神经渲染、仿真闭环、数据飞轮、车端推理、激光雷达、DRIVE Thor、智能网联标准、多模态大模型、安全冗余、GOD 网络 |
| 09-24 | [2026-09-24.md](./ch10_每日前沿/2026-09-24.md) | Robotaxi 全无人运营、周订单量、单车日均单量、城市 NOA 渗透率、车位到车位、端到端 OTA 推送、无人配送、干线物流编队、车路云一体化、接管里程、单均成本、收费运营、用户里程占比、安全冗余 |
| 09-23 | [2026-09-23.md](./ch10_每日前沿/2026-09-23.md) | 华为乾崑 ADS、小鹏图灵芯片、Momenta、元戎启行、Waymo、Mobileye、特斯拉 FSD、高通 Snapdragon Ride、百度萝卜快跑、小马智行、端到端、VLA、舱驾一体、Robotaxi 出海 |
| 09-22 | [2026-09-22.md](./ch10_每日前沿/2026-09-22.md) | 文远知行、Zoox、滴滴自动驾驶、前装量产、理想 VLA、蔚来世界模型、神玑 NX9031、征程 6P、HSD、禾赛科技、速腾聚创、英伟达 Thor、端到端量产 |
| 09-18 | [2026-09-18.md](./ch10_每日前沿/2026-09-18.md) | Robotaxi、Cybercab、萝卜快跑、小马智行、Waymo、华为乾崑、小鹏图灵、L3 商用、城市 NOA、无人配送、无人重卡、激光雷达、量产交付、机场接驳、海外运营 |
