...
$$
\color{Magenta}{\hat{x_k}} \color{Black}= 
\left[
\begin{matrix}
1 & \triangle t \\
0 & 1 \\
...
$$
\color{Magenta}{\hat{x_k}} \color{Black}= {F_k}\color{Blue}{\hat{x}_{k-1}} \color{Block}
\left[
\begin{matrix}
\frac{\triangle{t^2}}{2} \\
\triangle{t} \\
...
$$
\color{Blue}\hat{x}_k^\prime = \color{Magenta}\hat{x}_k \color{Block} + \color{DarkRed} K^\prime \color{Block} (\color{YellowGreen} \vec{z_k} \color{Block} - \color{Magenta} H_k \hat{x}_k \color{Block})
$$
