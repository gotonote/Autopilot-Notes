...
$$
\color{Magenta}{\hat{x}_{k}} \color{Black} = {F_k} \color{Blue}{\hat{x}_{k-1}} \color{Block} + B_k \color{Darkorange}{\vec{u}_k}
$$
...
$$
\color{Blue}{\hat{x}_k} \color{Block}= F_k 
\color{Magenta}{\hat{x}_{k-1}}
$$
